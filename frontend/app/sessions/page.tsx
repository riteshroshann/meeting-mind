...
// Remove the imports for TranslationDisplay and SummaryDisplay
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <Textarea
                  ...
                  className="min-h-[120px] resize-none text-sm" // Removed custom background/border for consistency
                  disabled={isProcessing}
                />
                {metadata && (
                  <p className="text-xs text-gray-500 mt-1">
