...
export function AudioUpload({ onFileUpload, disabled = false }: AudioUploadProps) {
        ...
        {isDragActive ? (
          ...
          <div>
            <p className="text-lg font-medium text-white">
              {disabled ? "Recording in progress..." : "Drag & drop your audio file here"}
            </p>
            <p className="text-white/70 mb-4">
              {disabled ? "Stop recording to upload files" : "or click to browse files"}
            </p>
            {!disabled && (
